...
import com.fazula.server.application.handler.StatusEndpointHandler;
import com.fazula.server.domain.model.Channel;
import com.fazula.server.infrastructure.config.FazulaConfig;
...
public class ChannelsVerticle extends AbstractVerticle {
    ...
    public void start(final Future<Void> startFuture) {
        ...
        this.beanContext.registerSingleton(new FazulaConfig(this.vertx), true);
